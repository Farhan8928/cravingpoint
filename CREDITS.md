...
| Asset | Source |
|---|---|
| `owner-portrait` | Client photograph (`owner-1.jpeg`) |
| `owner-candid` | Client photograph (`owner-2.jpeg`) |
...
| Asset | Source file |
|---|---|
| `dish-waffle` | `waffle.png` |
| `dish-tub` | `tubs.png` |
| `dish-sundae` | `sundaes.png` |
| `dish-doughnut` | `doughnuts.png` |
| `dish-wrap` | `wrap.png` |
| `dish-combo` | `combo.png` |
| `gift-boxes` | `tubs.png` |
